...
* Personal and free use (e.g., for playing)
* Viewing and studying the source code for learning purposes
...
* Fork the repository
* Redistribute the source code or executables
* Use the project or code for commercial purposes
* Reuse the source code in other projects
...
Questo progetto **NON è open source**. Il codice sorgente e tutti i file correlati sono forniti esclusivamente per gli scopi indicati di seguito.

**Usi consentiti**

* Scopi didattici e formativi
* Uso personale e gratuito (ad esempio, per giocare)
* Visualizzazione e studio del codice sorgente a fini di apprendimento
...
* Ridistribuire il codice sorgente o gli eseguibili
* Usare il progetto o il codice per scopi commerciali
* Riutilizzare il codice sorgente in altri progetti
